...
<html lang="en">
<head>
  <title>Imsakiyah ver 0.2 </title>
  <meta charset="utf-8" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  <meta http-equiv="content-language" content="en" />
  <meta name="author" content="Cahya DSN" />
  <meta name="viewport" content="width=device-width,initial-scale=1,user-scalable=no" />
  <meta name="keywords" content="Imsakiyah, Islamic, Prayertime, Google maps, jQuery, plugin, mobile, iphone, ipad, android, HTML5" />
  <meta name="description" content="Imsakiyah ver 0.2 islamic imsakiyah/prayertime schedule with Qibla direction created by cahya dsn" />
  <meta name="robots" content="index, follow" />
  <link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
  <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
  <link rel="stylesheet" href="https://www.w3schools.com/lib/w3-theme-blue.css">
  <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyC50pxURhVUYxNOxOSqwR_RYm2HLjnRdsA&sensor=false&libraries=geometry"></script>
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js"></script>
  <?php $h=isset($_GET['h'])?$_GET['h']:'1438'; ?>
  <script src="js/imsyak.ori.php?h=<?php echo $h;?>&v=<?php echo md5(filemtime('js/imsyak.ori.php'));?>"></script>
</head>
<body onload="initialize('Jakarta');codeAddress();">
<div class="w3-container">
<div class="w3-top">
    <div class="w3-bar w3-theme-d5">
        <span class="w3-bar-item">:: IMSAKv0.2</span>
...
<h2>&nbsp;</h2>
  ...
  $(function(){
    $( "#inp" ).click(function(){
      $('div#search select#address').removeClass('inp');
      $('#search').hide();
      $('div#searchbox input#address').addClass('inp');
      $('#searchbox').show();
    });
    $( "#inps" ).click(function(){
      $('div#searchbox input#address').removeClass('inp');
      $('#searchbox').hide();
      $('div#search select#address').addClass('inp');
      $('#search').show();    
    });    
  });    
  </script>
   <div class="w3-card-4">
	  <h2 class="w3-theme-d3 w3-center"><a name="#about"></a>About</h2>
      <div id="about" class="w3-center">
        Imsakiyah v0.2 <br />
        copyright &copy; 2015 - <?php echo date('Y');?> by <a href="mailto:cahyadsn@gmail.com">cahya dsn</a><br />
        <p>
        google api v3<br />
        jquery 1.7.1 (cdn from google)<br />
        w3.css 4.0
        </p>
        <p>
        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=K6YRM43CZ44UQ" class="w3-button w3-round-xlarge w3-theme-d4">donasi</a><br />BCA 1451332193<br /><br />
  ...
  <div class="w3-bottom">
	  <div class="w3-bar w3-theme-d4 w3-center">
		 Imsakiyah v0.2 copyright &copy; 2015 - <?php echo date('Y');?> by <a href="mailto:cahyadsn@gmail.com">cahya dsn</a><br />
	  </div>
  </div>
</div>
</body>
